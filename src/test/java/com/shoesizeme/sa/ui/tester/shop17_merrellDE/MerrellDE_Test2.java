package com.shoesizeme.sa.ui.tester.shop17_merrellDE;
...
public class MerrellDE_Test2 {
     ...
     *               In order to save time and test more element, Plus several more steps in each test(1-3) is to test some certain buttons r working well(like exit,close...).
     * @param
     * @return null
     * @version 1.0
     */
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("17728481");
        pc.inputShoeId("J000784");
        pc.selectLang("de-formal");
        pc.selectScale("eu");
        pc.generateSaButton();
        // ---user landing page
        pc.clickSA();
