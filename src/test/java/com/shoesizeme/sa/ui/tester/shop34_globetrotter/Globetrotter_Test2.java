package com.shoesizeme.sa.ui.tester.shop34_globetrotter;
...
public class Globetrotter_Test2 {
    /**
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("279375");
        pc.inputShoeId("H45548");
        pc.selectLang("de");
        pc.selectScale("eu");
        pc.generateSaButton();
        // ---user landing page
