package com.shoesizeme.sa.ui.tester.shop20_outfitter;
...
public class Outfitter_Test2 {
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("23433858");
        pc.inputShoeId("P213086");
        pc.selectLang("de");
        pc.selectScale("eu");
        pc.generateSaButton();
        // ---user landing page
