package com.shoesizeme.sa.ui.tester.shop21_helmboots;
...
public class Helmboots_Test2 {
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("23791617");
        pc.inputShoeId("4598176088126");
        pc.selectLang("en");
        pc.selectScale("us");
        pc.generateSaButton();
        // ---user landing page
