package com.shoesizeme.sa.ui.tester.shop28_hushpuppies;
...
public class Hushpuppies_Test2 {
    /**
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("25831171");
        pc.inputShoeId("HM01987-237");
        pc.selectLang("en");
        pc.selectScale("us");
        pc.generateSaButton();
        // ---user landing page
