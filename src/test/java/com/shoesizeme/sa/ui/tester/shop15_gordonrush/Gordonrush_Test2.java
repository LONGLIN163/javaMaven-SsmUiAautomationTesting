package com.shoesizeme.sa.ui.tester.shop15_gordonrush;
...
public class Gordonrush_Test2 {
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("29208519");
        pc.inputShoeId("4529153015941");
        pc.selectLang("en");
        pc.selectScale("us");
        pc.generateSaButton();
        // ---user landing page
