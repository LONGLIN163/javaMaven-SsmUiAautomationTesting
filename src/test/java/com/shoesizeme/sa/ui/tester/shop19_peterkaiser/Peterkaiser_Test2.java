package com.shoesizeme.sa.ui.tester.shop19_peterkaiser;
...
public class Peterkaiser_Test2 {
    /**
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("23105846");
        pc.inputShoeId("30417-S01");
        pc.selectLang("en");
        pc.selectScale("eu");
        pc.generateSaButton();
        // ---user landing page
