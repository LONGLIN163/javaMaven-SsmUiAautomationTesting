package com.shoesizeme.sa.ui.tester.shop14_intersport;
...
public class Intersport_Test2 {
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("25144532");
        pc.inputShoeId("G28038_000");
        pc.selectLang("de");
        pc.selectScale("eu");
        pc.generateSaButton();
        // ---user landing page
