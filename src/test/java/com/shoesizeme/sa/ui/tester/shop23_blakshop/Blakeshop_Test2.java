package com.shoesizeme.sa.ui.tester.shop23_blakshop;
...
public class Blakeshop_Test2 {
    ...
    public void test1() throws InterruptedException {
        ...
        pc.inputShopId("29666846");
        pc.inputShoeId("4458184081480");
        pc.selectLang("it");
        pc.selectScale("eu");
        pc.generateSaButton();
        // ---user landing page
